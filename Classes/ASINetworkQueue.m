...
- (void)setUploadProgressDelegate:(id __strong)newDelegate
{
...
- (void)setDownloadProgressDelegate:(id __strong)newDelegate
{
...
- (void)request:(ASIHTTPRequest *)request didReceiveBytes:(long long)bytes
{
	...
	if ([self downloadProgressDelegate]) {
		[ASIHTTPRequest updateProgressIndicator:(id*)&_downloadProgressDelegate withProgress:[self bytesDownloadedSoFar] ofTotal:[self totalBytesToDownload]];
	}
}
