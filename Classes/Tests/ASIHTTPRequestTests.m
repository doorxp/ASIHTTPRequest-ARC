...
- (void)testBasicDownload
{
	...
	url = [[NSURL alloc] initWithString:@"http://allseeing-i.com/a-page-that-does-not-exist"];
	...
	request = [[ASIHTTPRequest alloc] initWithURL:nil];
	[request startSynchronous];
...
- (void)testCharacterEncoding
{
	...
	for (i=0; i<[IANAEncodings count]; i++) {
		NSURL *url = [[NSURL alloc] initWithString:[NSString stringWithFormat:@"http://allseeing-i.com/ASIHTTPRequest/tests/Character-Encoding/%@",[IANAEncodings objectAtIndex:i]]];
	...
	NSURL *url = [[NSURL alloc] initWithString:@"http://allseeing-i.com/ASIHTTPRequest/tests/Character-Encoding/Something-else"];
	ASIHTTPRequest *request = [[ASIHTTPRequest alloc] initWithURL:url];
	...
	url = [[NSURL alloc] initWithString:@"http://allseeing-i.com/ASIHTTPRequest/tests/Character-Encoding/utf-16-with-type-header"];
	request = [[ASIHTTPRequest alloc] initWithURL:url];
	[request startSynchronous];
...
- (void)testTimeOut
{
	NSURL *url = [[NSURL alloc] initWithString:@"http://allseeing-i.com/ASIHTTPRequest/tests/the_great_american_novel_%28abridged%29.txt"];
	ASIHTTPRequest *request = [[ASIHTTPRequest alloc] initWithURL:url];
...
{
	NSURL *url = [[NSURL alloc] initWithString:@"http://allseeing-i.com/ASIHTTPRequest/tests/request-method"];
	NSArray *methods = [[NSArray alloc] initWithObjects:@"GET",@"POST",@"PUT",@"DELETE", nil];
...
{
	NSURL *url = [[NSURL alloc] initWithString:@"http://allseeing-i.com/ASIHTTPRequest/tests/http-version"];
	ASIHTTPRequest *request = [[ASIHTTPRequest alloc] initWithURL:url];
	[request startSynchronous];
...
{
	NSURL *url = [[NSURL alloc] initWithString:@"http://allseeing-i.com/i/logo.png"];
	ASIHTTPRequest *request = [[ASIHTTPRequest alloc] initWithURL:url];
	[request startSynchronous];
...
- (void)testCompressedResponseDownloadToFile
{
	...
	NSURL *url = [[NSURL alloc] initWithString:@"http://allseeing-i.com/ASIHTTPRequest/tests/first"];
	ASIHTTPRequest *request = [[ASIHTTPRequest alloc] initWithURL:url];
	[request setDownloadDestinationPath:path];
	[request startSynchronous];
...
- (void)testCompressedResponseDelegateDataHandling
{
	...
	NSURL *url = [[NSURL alloc] initWithString:@"http://allseeing-i.com/ASIHTTPRequest/tests/the_hound_of_the_baskervilles.text"];
	...
	NSString *delegateResponse = [[NSString alloc] initWithBytes:[responseData bytes] length:[responseData length] encoding:[request responseEncoding]];
	...
	delegateResponse = [[NSString alloc] initWithBytes:[responseData bytes] length:[responseData length] encoding:[request responseEncoding]];
...
{
	progress = 0;
	ASIHTTPRequest *request = [[ASIHTTPRequest alloc] initWithURL:[NSURL URLWithString:@"http://allseeing-i.com/ignore"]];
...
- (void)testCookies
{
	...
	NSURL *url = [[NSURL alloc] initWithString:@"http://allseeing-i.com/ASIHTTPRequest/tests/set_cookie"];
	ASIHTTPRequest *request = [[ASIHTTPRequest alloc] initWithURL:url];
	...
	url = [[NSURL alloc] initWithString:@"http://allseeing-i.com/ASIHTTPRequest/tests/read_cookie"] ;
	request = [[ASIHTTPRequest alloc] initWithURL:url];
	...
	url = [[NSURL alloc] initWithString:@"http://allseeing-i.com/ASIHTTPRequest/tests/remove_cookie"];
	request = [[ASIHTTPRequest alloc] initWithURL:url];
	[request startSynchronous];
	html = [request responseString];
	...
	url =  initWithString:@"http://allseeing-i.com/ASIHTTPRequest/tests/read_cookie"] autorelease];;
	request = [[ASIHTTPRequest alloc] initWithURL:url];
	[request setUseCookiePersistence:NO];
	[request setRequestCookies:[NSMutableArray arrayWithObject:cookie]];
	[request startSynchronous];
	...
	url =  initWithString:@"http://allseeing-i.com/ASIHTTPRequest/tests/set_cookie"] autorelease];;
	request = [[ASIHTTPRequest alloc] initWithURL:url];
	[request setUseCookiePersistence:YES];
...
- (void)testBasicAuthentication
{
	...
	request = [[ASIHTTPRequest alloc] initWithURL:[NSURL URLWithString:@"http://allseeing-i.com/ASIHTTPRequest/tests/basic-authentication-new-credentials"]];
...
- (void)testDigestAuthentication
{
	...
	NSURL *url = [[NSURL alloc] initWithString:@"http://allseeing-i.com/ASIHTTPRequest/tests/digest-authentication"];
	ASIHTTPRequest *request;
	BOOL success;
	NSError *err;
	...
	// Ensure credentials stored in the session were wiped
	request = st alloc] initWithURL:url] autorelease];;
	[request setUseKeychainPersistence:NO];
	[request startSynchronous];
	success = [[request error] code] == ASIAuthenticationErrorType;
	GHAssertTrue(success,@"Failed to clear credentials");
...
- (void)testCompressedResponse
{
	...
	NSURL *url =  initWithString:@"http://allseeing-i.com/i/logo.png"] autorelease];;
	ASIHTTPRequest *request = st alloc] initWithURL:url] autorelease];;
	[request startSynchronous];
	...
	url =  initWithString:@"http://allseeing-i.com/ASIHTTPRequest/tests/first"] autorelease];;
	request = st alloc] initWithURL:url] autorelease];;
	[request startSynchronous];
	success = ([request rawResponseData] != [request responseData]);
...
- (void)performPartialFetchTest
{
	...
	progress = 0;
	NSURL *url =  initWithString:@"http://allseeing-i.com/ASIHTTPRequest/tests/test_partial_download.txt"] autorelease];;
	ASIHTTPRequest *request = st alloc] initWithURL:url] autorelease];;
	[request setDownloadDestinationPath:downloadPath];
...
- (void)testThrottlingUploadBandwidth
{
	...
	NSData *data = a alloc] initWithLength:64*1024] autorelease];;
...
- (void)theTestRequestFinished:(ASIHTTPRequest *)request
{
	...
	[request2 startSynchronous];
	NSString *firstResponse = oc] initWithBytes:[[self responseData] bytes] length:[[self responseData] length] encoding:[request responseEncoding]] autorelease];;
...
- (void)testRFC1123DateParsing
{
	...
	NSCalendar *calendar = lloc] initWithCalendarIdentifier:NSGregorianCalendar] autorelease];;
...
- (void)testResumeWithAutomaticTimeoutRetry
{
	...
	for (i=0; i<3; i++) {
		...
		expectedOutput =  stringByAppendingString:[[[NSString alloc] initWithBytes:s length:1024*128 encoding:NSUTF8StringEncoding] autorelease]]];
