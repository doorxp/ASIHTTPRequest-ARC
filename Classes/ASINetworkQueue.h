...
@property (readonly, nonatomic, setter=setUploadProgressDelegate:) id uploadProgressDelegate;
@property (readonly, nonatomic, setter=setDownloadProgressDelegate:) id downloadProgressDelegate;
